...
// `extensions.artifactAuthoring`), and when it was declared. The
...
const DISCLAIMER =
  "This manifest records only what artifact-authoring's own generation pipeline declared " +
 ...
 * `extensions.artifactAuthoring` (checklist scores plus whatever
...
export function buildArtifactManifest({ type, slug, version, frontmatter }) {
  ...
  const generatorExtensions = frontmatter.extensions?.artifactAuthoring ?? null;
