...
`modeled-information-format/.github` (the workflow that ran the signing job), not to this
...
```
Loaded digest sha256:abc123... for file://claude-code-plugins-0.3.1.tar.gz
